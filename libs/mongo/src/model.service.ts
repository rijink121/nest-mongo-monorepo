...
export class ModelService<M extends MongoSchema> {
   ...
   * @example
   * ```typescript
   * protected async doBeforeRead(job: MongoJob<User>): Promise<void> {
   ...
   * @example
   * ```typescript
   * protected async doBeforeFind(job: MongoJob<User>): Promise<void> {
   *   // Add access control or additional filtering
   *   if (!job.options) job.options = {};
   *   job.options.populate = ['profile', 'roles'];
   * }
   * ```
   */
   ...
   * @example
   * ```typescript
   * protected async doBeforeFindAll(job: MongoJob<User>): Promise<void> {
   *   // Add sorting or filtering logic
   *   if (!job.options) job.options = {};
   *   job.options.sort = { created_at: -1 };
   * }
   * ```
   */
   ...
   * @example
   * ```typescript
   * protected async doBeforeCount(job: MongoJob<User>): Promise<void> {
   *   // Add filtering for count operation
   *   if (!job.options) job.options = {};
   *   job.options.where = { ...job.options.where, deleted: false };
   * }
   * ```
   */
   ...
   * @example
   * ```typescript
   * protected async doBeforeWrite(job: MongoJob<User>): Promise<void> {
   ...
   * @example
   * ```typescript
   * protected async doBeforeCreate(job: MongoJob<User>): Promise<void> {
   *   // Set default values or validate required fields
   *   if (job.body) {
   *     job.body.created_at = new Date();
   ...
   * @example
   * ```typescript
   * protected async doBeforeUpdate(job: MongoJob<User>): Promise<void> {
   ...
   * @example
   * ```typescript
   * protected async doBeforeDelete(job: MongoJob<User>): Promise<void> {
   ...
   *   job: MongoJob<User>,
   *   response: MongoGetOneResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterFind(
    job: MongoJob<M>,
    _response: MongoGetOneResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
   ...
   *   job: MongoJob<User>,
   *   response: MongoGetAllResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterFindAll(
    job: MongoJob<M>,
    _response: MongoGetAllResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
   ...
   *   job: MongoJob<User>,
   *   response: MongoCreateResponse<User> | MongoUpdateResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterWrite(
    job: MongoJob<M>,
    _response: MongoCreateResponse<M> | MongoUpdateResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
   ...
   *   job: MongoJob<User>,
   *   response: MongoCreateResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterCreate(
    job: MongoJob<M>,
    _response: MongoCreateResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
   ...
   *   job: MongoJob<User>,
   *   response: MongoUpdateResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterUpdate(
    job: MongoJob<M>,
    _response: MongoUpdateResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
   ...
   *   job: MongoJob<User>,
   *   response: MongoDeleteResponse<User>
   * ): Promise<void> {
  ...
  protected async doAfterDelete(
    job: MongoJob<M>,
    _response: MongoDeleteResponse<M>,
  ): Promise<void> {
    // Default implementation - child classes can override
  }
}
